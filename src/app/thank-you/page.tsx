...
const ThankYouPage = async ({ searchParams }: ThankYouPageProps) => {
  ...
  const { docs: dbOrders } = await payload.find({
    collection: "orders",
    depth: 2,
    where: {
      id: {
        ...
        <div className="lg:col-start-2">
          ...
          {order._is_paid ? (
            ...
            <p className="mt-2 text-base text-muted-foreground">
              ...
              We will send you confirmation soon!
            </p>
          )}
          ...
          <div className="mt-16 text-sm font-medium">
            ...
            <div className="space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground">
              <div className="flex justify-between">
                <p>Subtotal</p>
                <p className="text-gray-900">{formatPrice(orderTotalPrice)}</p>
              </div>
              ...
              <div className="flex items-center justify-between border-t border-gray-200 pt-6 text-gray-900">
                ...
                <p className="text-base">
                  {formatPrice(orderTotalPrice + transactionFee)}
                </p>
              </div>
            </div>
